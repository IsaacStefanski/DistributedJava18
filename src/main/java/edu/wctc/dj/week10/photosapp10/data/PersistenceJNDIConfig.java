package edu.wctc.dj.week10.photosapp10.data;
...
@EnableJpaRepositories(basePackages = "edu.wctc.dj.week10.photosapp10")
public class PersistenceJNDIConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() throws NamingException {
        ...
        emf.setPackagesToScan("edu.wctc.dj.week10.photosapp10");
    ...
    public DataSource dataSource() throws NamingException {
        return (DataSource) new JndiTemplate().lookup("java:comp/env/jdbc/myPhotos");
    }
